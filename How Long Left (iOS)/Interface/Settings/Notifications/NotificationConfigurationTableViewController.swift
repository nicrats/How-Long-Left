...
class NotificationConfigurationTableViewController: UITableViewController, NotificationAccessDelegate {
    ...
    func presentTextBox(for type: NotificationTriggerType, value: Int? = nil) {
    ...
    func presentEventStatusSelectAlert() {
        ...
        let actionSheet = UIAlertController(title: "Add Event Status Notification", message: "Select a trigger", preferredStyle: .actionSheet)
