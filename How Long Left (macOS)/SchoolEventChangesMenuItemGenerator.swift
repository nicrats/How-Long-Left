...
class SchoolEventChangesMenuItemGenerator {
    ...
    func generateSchoolEventChangesSubmenu() -> NSMenu? {
        ...
        for event in changedEvents {
            ...
            eventMenuItem.action = #selector(SelectionMenuItemHandler.shared.selectEventFromMenuItem(sender:))
            eventMenuItem.target = SelectionMenuItemHandler.shared
            SelectionMenuItemHandler.shared.addItemWithEvent(item: eventMenuItem, event: event)
