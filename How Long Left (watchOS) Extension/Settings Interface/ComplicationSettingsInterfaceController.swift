...
class ComplicationSettingsInterfaceController: WKInterfaceController {
    ...
    @IBAction func showEventsToggled(_ value: Bool) {
        ...
        if HLLDefaults.complication.complicationPurchased {
            ...
            self.presentAlert(withTitle: "Complication Not Purchased", message: "You can purchase it using the How Long Left app on your iPhone.", preferredStyle: .alert, actions: [action])
